# Jello-Hover Tabs - Minimalist Tech Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Jello-Hover interaction transition, styled to complement Minimalist Tech interface aesthetics. Clean, modern, with playful jello wobbles.
...
submissions/examples/jello-tabs-minimalist-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
