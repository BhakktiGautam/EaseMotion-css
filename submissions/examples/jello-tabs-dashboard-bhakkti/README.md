# Jello-Hover Tabs - Responsive Dashboard Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Jello-Hover interaction transition, styled to complement Responsive Dashboard interface aesthetics. Playful, professional, and responsive.
...
submissions/examples/jello-tabs-dashboard-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
