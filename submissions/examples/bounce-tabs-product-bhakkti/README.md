# Elastic Bounce Tabs - Product Catalog Component

##  Overview
A pure CSS animated tabs component utilizing a smooth Elastic Bounce interaction transition, styled to complement Product Catalog interface aesthetics. Playful and e-commerce focused.
...
submissions/examples/bounce-tabs-product-bhakkti/
├── demo.html
├── style.css
└── README.md
### Credits
